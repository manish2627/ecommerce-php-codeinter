...
// $nav_menu = [
//     'category' => ['All Ctegory' =>  base_url().'/category/all_category.php', 'Add new Category'=>base_url().'/category/add_new_category.php'],
//     'Products' => ['All Products'=> base_url().'/product/all_products.php', 'Add new Product '=>base_url().'/product/add_new_product.php'],
//     'Users' => ['All Users'=> base_url().'/blogs/all_user.php', 'Add new Users '=>base_url().'/product/add_new_user.php'],
//     'Blogs' => ['All Blogs'=> base_url().'/blogs/all_blogs.php', 'Add new Blog '=>base_url().'/blogs/add_new_blog.php'],
//     'Orders' => ['All Orders'=> base_url().'/all_order.php', 'Add new Order '=>base_url().'/add_new_order.php'],
// ];
$nav_menu = [
    [
       'menu_name'=>'Category',
    ...
    [
       'menu_name'=>'Users',
       'sub_menu' => [
           ['submenu_name' => 'All Users','url' => base_url().'/admin/users/all_users.php'],
        //    ['submenu_name' => 'Add new Users','url' => base_url().'/users/add_new_user.php']
       ]
   ],
   [
       'menu_name'=>'Blogs',
       'sub_menu' => [
           ['submenu_name' => 'All Blogs','url' => base_url().'/admin/blogs/all_blogs.php'],
           ['submenu_name' => 'Add new Blog','url' => base_url().'/admin/blogs/add_new_blog.php']
       ]
   ],
//     [
//        'menu_name'=>'Orders',
//        'sub_menu' => [
//            ['submenu_name' => 'All Orders','url' => base_url().'/admin/orders/all_orders.php'],
